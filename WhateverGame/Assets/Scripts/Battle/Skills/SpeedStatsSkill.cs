...
public class SpeedStatsSkill : BaseSkill
{
    [Header("Specific VFX")]
    ...
    public override IEnumerator ExecuteSkillSequence()
    {
        ...
        SpeedStatus status = atk_vfx.GetComponent<SpeedStatus>();
        status.spdChangePercentage = (int)(baseDamageMultiplier * 100f);
    ...
    public override SkillPreview GetPreviewValue(ActorController caster, ActorController target, int overload)
    {
        ...
        ret.chance_text = "100%";
        ret.chance_val = 1f;
        ret.value = "+" + (baseDamageMultiplier * caster.actorStats.currentStats.speed) + " Speed";
        return ret;
    }
